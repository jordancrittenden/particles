    ...
    glm::u32 maxParticles)
{
    ...
    wgpu::ShaderModule computeShaderModule = create_shader_module(device, "kernel/particles_pic.wgsl", {"kernel/physical_constants.wgsl", "kernel/field_common.wgsl", "kernel/mesh.wgsl"});
